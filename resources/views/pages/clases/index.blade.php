...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a class="btn btn-primary shadow-md mr-2" href="{{ route('clases.create') }}">+ Agregar</a>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">SIGLA</th>
                ...
                <tbody>
                    @foreach ($clases as $clases)
                        <tr class="intro-x">
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $clases->nombre }}</a>
                            </td>
                            <td class="text-center">{{ $clases->sigla }}</td>
                            <td class="w-40">
