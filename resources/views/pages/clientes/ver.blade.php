...
@section('subcontent')
<h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">Lista de Clientes</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2">Agregar cliente</button>
            <div class="dropdown">
